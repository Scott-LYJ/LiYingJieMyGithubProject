  ...
  <!--工具条-->
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                 ...
                 <el-form-item>
                   编码：<el-input v-model="filters.id"   placeholder="编码" style="width:200px; heght:30px;" size="mini"></el-input>
                </el-form-item>
                 <el-form-item>
                   岗位： <el-input v-model="filters.phone"  placeholder="手机" style="width:200px; heght:30px;" size="mini"></el-input>
                </el-form-item>
                <br>
                 <el-form-item>
                   登录名：<el-input v-model="filters.cdt"   placeholder="创建日期" style="width:200px; heght:30px;" size="mini"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <el-table :data="tableData" size="mini"  highlight-current-row border   class="el-tb-edit mgt20" ref="multipleTable" tooltip-effect="dark" v-loading="listLoading" @selection-change="selectChange">
            ...
            <el-table-column prop="id" label="编码" >
             ...
             <el-table-column prop="cdt" label="创建时间" >
            </el-table-column>
            <el-table-column prop="udt" label="最近修改时间" >
            </el-table-column>
             <!--<el-table-column prop="udt" label="性别" :formatter="formatSex" sortable>-->
            <!--</el-table-column>-->
...
export default {
  ...
  // console.log("请求querySysUserLIst")
  //  apis.adminApi.querySysUserList(param)
  //     .then(resultData=>{
